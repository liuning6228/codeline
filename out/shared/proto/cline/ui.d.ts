...
export declare enum ClineMessageType {
    ASK = 0,
    SAY = 1
}
export declare enum ClineAsk {
    UNRECOGNIZED = -1,
    FOLLOWUP = 0,
    PLAN_MODE_RESPOND = 1,
    COMMAND = 2,
...
export declare enum ClineSayToolType {
...
export declare enum BrowserAction {
    LAUNCH = 0,
    CLICK = 1,
    TYPE = 2,
    SCROLL_DOWN = 3,
...
export declare enum McpServerRequestType {
    USE_MCP_TOOL = 0,
    ACCESS_MCP_RESOURCE = 1
}
export declare enum ClineApiReqCancelReason {
    STREAMING_FAILED = 0,
    USER_CANCELLED = 1,
    RETRIES_EXHAUSTED = 2
}
