...
exports.languageOptions = exports.DEFAULT_LANGUAGE_SETTINGS = void 0;
exports.getLanguageKey = getLanguageKey;
exports.DEFAULT_LANGUAGE_SETTINGS = "en";
...
function getLanguageKey(display) {
    if (!display) {
        return exports.DEFAULT_LANGUAGE_SETTINGS;
    }
    const languageOption = exports.languageOptions.find((option) => option.display === display);
    if (languageOption) {
