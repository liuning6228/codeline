...
exports.HOOK_OUTPUT_STRING = void 0;
exports.combineHookSequences = combineHookSequences;
function getSay(msg) {
    // Back-compat: older recordings may be deserialized without strict typing.
    return msg.say;
}
function isHookStatusSay(say) {
    return say === "hook_status" || say === "hook";
}
function isHookOutputStreamSay(say) {
...
function parseHookMetadata(hookMessage) {
    ...
    try {
        const outputIndex = hookMessage.text.indexOf(exports.HOOK_OUTPUT_STRING);
 ...
 */
function dedupeToolOrCommandMessagesByTimestamp(messages) {
    const lastToolOrCommandIndexByTs = new Map();
 ...
 */
function combineHookSequences(messages) {
...
exports.HOOK_OUTPUT_STRING = "__HOOK_OUTPUT__";
