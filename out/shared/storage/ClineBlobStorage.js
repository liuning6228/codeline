...
exports.blobStorage = exports.ClineBlobStorage = void 0;
 ...
 */
class ClineBlobStorage extends ClineStorage_1.ClineStorage {
    ...
    init(settings) {
        ...
        try {
            ...
            const adapter = (0, adapters_1.getStorageAdapter)(settings);
            if (adapter) {
                this.adapter = adapter;
                this.settings = settings;
                this.initialized = true;
                Logger_1.Logger.log(`[ClineBlobStorage] Adapter created for ${settings.adapterType}`);
            }
        }
        catch (error) {
            // Log but don't throw - allow startup to continue
            Logger_1.Logger.error("[ClineBlobStorage] initialization failed:", error);
        }
    }
    /**
...
exports.ClineBlobStorage = ClineBlobStorage;
/**
 * Get the blob storage instance if S3/R2 storage is configured.
 * Returns null if not configured.
 */
exports.blobStorage = ClineBlobStorage.instance;
