...
exports.applyTransform = exports.hasTransform = exports.getDefaultValue = exports.isComputedProperty = exports.isAsyncProperty = exports.isLocalStateKey = exports.isSecretKey = exports.isSettingsKey = exports.isGlobalStateKey = exports.COMPUTED_PROPERTIES = exports.ASYNC_PROPERTIES = exports.SETTINGS_TRANSFORMS = exports.SETTINGS_DEFAULTS = exports.GLOBAL_STATE_DEFAULTS = exports.GlobalStateAndSettingKeys = exports.ApiHandlerSettingsKeys = exports.SettingsKeys = exports.SecretKeys = exports.LocalStateKeys = void 0;
const AutoApprovalSettings_1 = require("@shared/AutoApprovalSettings");
const api_1 = require("@shared/api");
const BrowserSettings_1 = require("@shared/BrowserSettings");
const FocusChainSettings_1 = require("@shared/FocusChainSettings");
const McpDisplayMode_1 = require("@shared/McpDisplayMode");
...
const GLOBAL_STATE_FIELDS = {
    ...
    cliKanbanMigrationAnnouncementShown: { default: false },
    mcpDisplayMode: { default: McpDisplayMode_1.DEFAULT_MCP_DISPLAY_MODE },
...
const API_HANDLER_SETTINGS_FIELDS = {
    ...
    planModeApiProvider: { default: api_1.DEFAULT_API_PROVIDER },
    actModeApiProvider: { default: api_1.DEFAULT_API_PROVIDER },
...
const USER_SETTINGS_FIELDS = {
    ...
    autoApprovalSettings: {
        default: AutoApprovalSettings_1.DEFAULT_AUTO_APPROVAL_SETTINGS,
    },
    globalClineRulesToggles: { default: {} },
    globalWorkflowToggles: { default: {} },
    globalSkillsToggles: { default: {} },
    browserSettings: {
        default: BrowserSettings_1.DEFAULT_BROWSER_SETTINGS,
        transform: (v) => ({ ...BrowserSettings_1.DEFAULT_BROWSER_SETTINGS, ...v }),
    },
    ...
    mode: { default: "act" },
    focusChainSettings: { default: FocusChainSettings_1.DEFAULT_FOCUS_CHAIN_SETTINGS },
...
exports.SecretKeys = Array.from(SECRETS_KEYS);
exports.SettingsKeys = Array.from(SettingsKeysSet);
exports.ApiHandlerSettingsKeys = Array.from(ApiHandlerSettingsKeysSet);
exports.GlobalStateAndSettingKeys = Array.from(GlobalStateAndSettingsKeySet);
// GENERATED DEFAULTS - Auto-generated from property definitions
// ============================================================================
exports.GLOBAL_STATE_DEFAULTS = extractDefaults(GLOBAL_STATE_FIELDS);
exports.SETTINGS_DEFAULTS = extractDefaults(SETTINGS_FIELDS);
exports.SETTINGS_TRANSFORMS = extractTransforms(SETTINGS_FIELDS);
exports.ASYNC_PROPERTIES = extractMetadata({ ...GLOBAL_STATE_FIELDS, ...SETTINGS_FIELDS }, "isAsync");
exports.COMPUTED_PROPERTIES = extractMetadata({ ...GLOBAL_STATE_FIELDS, ...SETTINGS_FIELDS }, "isComputed");
// ============================================================================
// HELPER FUNCTIONS
// ============================================================================
const isGlobalStateKey = (key) => GlobalStateKeys.has(key);
exports.isGlobalStateKey = isGlobalStateKey;
const isSettingsKey = (key) => SettingsKeysSet.has(key);
exports.isSettingsKey = isSettingsKey;
const isSecretKey = (key) => new Set(SECRETS_KEYS).has(key);
exports.isSecretKey = isSecretKey;
const isLocalStateKey = (key) => new Set(exports.LocalStateKeys).has(key);
exports.isLocalStateKey = isLocalStateKey;
// ============================================================================
// UTILITY FUNCTIONS
// ============================================================================
const isAsyncProperty = (key) => exports.ASYNC_PROPERTIES.has(key);
exports.isAsyncProperty = isAsyncProperty;
const isComputedProperty = (key) => exports.COMPUTED_PROPERTIES.has(key);
exports.isComputedProperty = isComputedProperty;
const getDefaultValue = (key) => {
    return (exports.GLOBAL_STATE_DEFAULTS[key] ?? exports.SETTINGS_DEFAULTS[key]);
};
exports.getDefaultValue = getDefaultValue;
const hasTransform = (key) => key in exports.SETTINGS_TRANSFORMS;
exports.hasTransform = hasTransform;
const applyTransform = (key, value) => {
    const transform = exports.SETTINGS_TRANSFORMS[key];
