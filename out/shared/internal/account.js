...
exports.isClineBotUser = isClineBotUser;
exports.isClineInternalTester = isClineInternalTester;
/**
 ...
 */
function isClineBotUser(email) {
    return email.endsWith("@cline.bot");
}
function isClineInternalTester(email) {
