...
exports.remoteConfigToOtelConfig = remoteConfigToOtelConfig;
exports.isOpenTelemetryConfigValid = isOpenTelemetryConfigValid;
exports.getValidOpenTelemetryConfig = getValidOpenTelemetryConfig;
exports.getValidRuntimeOpenTelemetryConfig = getValidRuntimeOpenTelemetryConfig;
const core_1 = require("@opentelemetry/core");
const constants_1 = require("@/shared/constants");
const isTestEnv = process.env.E2E_TEST === "true" || process.env.IS_TEST === "true";
function remoteConfigToOtelConfig(settings) {
    return {
...
function getOtelConfig() {
    return {
        enabled: constants_1.BUILD_CONSTANTS.OTEL_TELEMETRY_ENABLED === "1" || constants_1.BUILD_CONSTANTS.OTEL_TELEMETRY_ENABLED === "true",
        metricsExporter: constants_1.BUILD_CONSTANTS.OTEL_METRICS_EXPORTER,
        logsExporter: constants_1.BUILD_CONSTANTS.OTEL_LOGS_EXPORTER,
        otlpProtocol: constants_1.BUILD_CONSTANTS.OTEL_EXPORTER_OTLP_PROTOCOL,
        otlpEndpoint: constants_1.BUILD_CONSTANTS.OTEL_EXPORTER_OTLP_ENDPOINT,
        metricExportInterval: constants_1.BUILD_CONSTANTS.OTEL_METRIC_EXPORT_INTERVAL
            ? Number.parseInt(constants_1.BUILD_CONSTANTS.OTEL_METRIC_EXPORT_INTERVAL, 10)
            : undefined,
        otlpHeaders: constants_1.BUILD_CONSTANTS.OTEL_EXPORTER_OTLP_HEADERS
            ? (0, core_1.parseKeyPairsIntoRecord)(constants_1.BUILD_CONSTANTS.OTEL_EXPORTER_OTLP_HEADERS)
            : undefined,
    };
}
/**
...
function getRuntimeOtelConfig() {
    return {
        ...
        otlpHeaders: process.env.CLINE_OTEL_EXPORTER_OTLP_HEADERS
            ? (0, core_1.parseKeyPairsIntoRecord)(process.env.CLINE_OTEL_EXPORTER_OTLP_HEADERS)
            : undefined,
    };
}
function isOpenTelemetryConfigValid(config) {
 ...
 */
function getValidOpenTelemetryConfig() {
    const config = getOtelConfig();
    return isOpenTelemetryConfigValid(config) ? config : null;
}
function getValidRuntimeOpenTelemetryConfig() {
