...
exports.fromProtobufModelInfo = fromProtobufModelInfo;
exports.toProtobufModelInfo = toProtobufModelInfo;
exports.fromProtobufOpenAiCompatibleModelInfo = fromProtobufOpenAiCompatibleModelInfo;
exports.fromProtobufLiteLLMModelInfo = fromProtobufLiteLLMModelInfo;
exports.fromProtobufOcaModelInfo = fromProtobufOcaModelInfo;
exports.fromProtobufModels = fromProtobufModels;
exports.toProtobufModels = toProtobufModels;
...
function convertThinkingConfig(protoConfig) {
    ...
    return {
        ...
        outputPriceTiers: protoConfig.outputPriceTiers && protoConfig.outputPriceTiers.length > 0 ? protoConfig.outputPriceTiers : undefined,
    };
}
/**
...
function toProtobufThinkingConfig(appConfig) {
    ...
    return models_1.ThinkingConfig.create({
 ...
 */
function fromProtobufModelInfo(protoInfo) {
    return {
        ...
        tiers: protoInfo.tiers && protoInfo.tiers.length > 0 ? protoInfo.tiers : undefined,
    };
}
/**
 * Convert application ModelInfo to protobuf OpenRouterModelInfo
 */
function toProtobufModelInfo(modelInfo) {
    return models_1.OpenRouterModelInfo.create({
 ...
 */
function fromProtobufOpenAiCompatibleModelInfo(protoInfo) {
    return {
        maxTokens: protoInfo.maxTokens,
        contextWindow: protoInfo.contextWindow,
        supportsImages: protoInfo.supportsImages,
 ...
 */
function fromProtobufLiteLLMModelInfo(protoInfo) {
    return {
        maxTokens: protoInfo.maxTokens,
        contextWindow: protoInfo.contextWindow,
        supportsImages: protoInfo.supportsImages,
 ...
 */
function fromProtobufOcaModelInfo(protoInfo) {
    return {
        maxTokens: protoInfo.maxTokens,
        contextWindow: protoInfo.contextWindow,
        supportsImages: protoInfo.supportsImages,
 ...
 */
function fromProtobufModels(protoModels) {
    const result = {};
 ...
 */
function toProtobufModels(models) {
    const result = {};
