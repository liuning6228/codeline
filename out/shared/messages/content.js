...
exports.REASONING_DETAILS_PROVIDERS = void 0;
exports.convertClineStorageToAnthropicMessage = convertClineStorageToAnthropicMessage;
exports.cleanContentBlock = cleanContentBlock;
exports.REASONING_DETAILS_PROVIDERS = ["cline", "openrouter"];
/**
 ...
 */
function convertClineStorageToAnthropicMessage(clineMessage, provider = "anthropic") {
    ...
    const shouldCleanContent = !exports.REASONING_DETAILS_PROVIDERS.includes(provider);
