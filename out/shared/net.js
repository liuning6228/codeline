...
exports.mockFetchForTesting = mockFetchForTesting;
exports.getAxiosSettings = getAxiosSettings;
exports.createOpenAIClient = createOpenAIClient;
const openai_1 = __importDefault(require("openai"));
const undici_1 = require("undici");
// TODO: Replace with actual implementation from @/services/EnvUtils
function buildExternalBasicHeaders() {
    return {};
}
let mockFetch;
/**
...
exports.fetch = (() => {
    ...
    if (process.env.IS_STANDALONE === "true") {
        ...
        const agent = new undici_1.EnvHttpProxyAgent({});
        (0, undici_1.setGlobalDispatcher)(agent);
        baseFetch = undici_1.fetch;
    }
 ...
 */
function mockFetchForTesting(theFetch, callback) {
 ...
 * ```
 */
function getAxiosSettings() {
    return {
        adapter: "fetch",
        fetch: exports.fetch, // Use our configured fetch
    };
}
/**
...
function createOpenAIClient(options) {
    ...
    return new openai_1.default({
        ...
        fetch: exports.fetch, // Use configured fetch with proxy support
    });
}
