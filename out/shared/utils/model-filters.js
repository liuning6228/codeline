...
exports.isClineFreeModelException = isClineFreeModelException;
exports.filterOpenRouterModelIds = filterOpenRouterModelIds;
function normalizeModelId(modelId) {
    return modelId.trim().toLowerCase();
}
const CLINE_FREE_MODEL_EXCEPTIONS = ["minimax-m2", "devstral-2512", "arcee-ai/trinity-large"];
function isClineFreeModelException(modelId) {
 ...
 */
function filterOpenRouterModelIds(modelIds, provider, allowedFreeModelIds = []) {
    if (provider === "cline") {
...
//# sourceMappingURL=model-filters.js.map