 ...
 * 支持Claude Code三层权限架构
 */
import { PermissionRule as BasePermissionRule, ToolPermissionContext, PermissionLevel as BasePermissionLevel } from '../Tool';
 ...
 * 增强的权限级别（扩展基础级别）
 */
export declare enum EnhancedPermissionLevel {
    /** 无权限 */
    NONE = "none",
    /** 只读权限 */
    READ = "read",
...
export declare const PermissionLevel: {
    /** 无权限 */
    readonly NONE: EnhancedPermissionLevel.NONE;
    /** 只读权限 */
    readonly READ: EnhancedPermissionLevel.READ;
    /** 写入权限 */
    readonly WRITE: EnhancedPermissionLevel.WRITE;
    /** 执行权限 */
    readonly EXECUTE: EnhancedPermissionLevel.EXECUTE;
    /** 管理员权限 */
    readonly ADMIN: EnhancedPermissionLevel.ADMIN;
};
/**
 * 增强的权限规则
