...
exports.bashCommandIsSafeAsync = bashCommandIsSafeAsync;
exports.bashCommandIsSafe = bashCommandIsSafe;
...
exports.validateDangerousPatterns = validateDangerousPatterns;
exports.hasMalformedTokens = hasMalformedTokens;
/**
 * 异步检查命令安全性
 */
async function bashCommandIsSafeAsync(params, context) {
 ...
 * 检查命令是否安全（同步版本）
 */
function bashCommandIsSafe(command, context) {
    // 基本安全检查
 ...
 * 检查命令操作符权限
 */
function checkCommandOperatorPermissions(command, context) {
    // 检查管道操作符
    if (command.includes('|')) {
 ...
 * 验证危险模式
 */
function validateDangerousPatterns(command, context) {
    const warnings = [];
    // 检查反引号命令替换
 ...
 * 检查是否有格式错误的令牌
 */
function hasMalformedTokens(command) {
    // 检查不匹配的引号
