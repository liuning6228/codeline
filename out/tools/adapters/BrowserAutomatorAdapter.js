 ...
 * 浏览器自动化适配器
 */
class BrowserAutomatorAdapter extends ToolAdapter_1.BaseToolAdapter {
    browserAutomator;
    constructor(context) {
        super('browser-automator', 'Browser Automator', 'Automate web browser interactions: navigation, content extraction, testing', '1.0.0', 'CodeLine Team', ['browser', 'web', 'automation', 'scraping', 'testing', 'navigation'], {
            mode: {
                type: 'string',
    ...
    async execute(params, context, onProgress) {
        ...
        try {
            ...
            if (browserResult.success) {
                ...
                return this.createErrorResult(`Browser automation failed: ${browserResult.error || 'Unknown error'}`, duration, {
                    mode,
                    url: browserResult.url || url,
            ...
            return this.createErrorResult(`Browser automation failed: ${error.message}`, duration, {
                mode,
                url,
            });
        }
...
//# sourceMappingURL=BrowserAutomatorAdapter.js.map