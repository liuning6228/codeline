 ...
 * 任务事件类型枚举
 */
export type TaskEventType = 'task_started' | 'analyzing_project' | 'project_analyzed' | 'consulting_ai' | 'ai_response_received' | 'steps_parsed' | 'step_started' | 'step_completed' | 'step_failed' | 'task_completed' | 'task_failed' | 'task_ended' | 'task_progress' | 'task_cancelled';
/**
 * 任务事件基接口
 */
 ...
 * 任务事件联合类型
 */
export type TaskEventUnion = TaskStartedEvent | AnalyzingProjectEvent | ProjectAnalyzedEvent | ConsultingAIEvent | AIResponseReceivedEvent | StepsParsedEvent | StepStartedEvent | StepCompletedEvent | StepFailedEvent | TaskCompletedEvent | TaskFailedEvent | TaskEndedEvent | TaskCancelledEvent | TaskProgressEvent;
/**
 * 异步生成器返回类型
 */
