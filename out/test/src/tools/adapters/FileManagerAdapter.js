 ...
 * 文件管理工具适配器
 */
class FileManagerAdapter extends ToolAdapter_1.BaseToolAdapter {
    fileManager;
    constructor(context) {
        super('file-manager', 'File Manager', 'File system operations (create, read, update, delete, list, copy, move)', '1.0.0', 'CodeLine Team', ['filesystem', 'file', 'directory', 'read', 'write', 'delete', 'copy', 'move'], {
            operation: {
                type: 'string',
        ...
        this.fileManager = new fileManager_1.FileManager(context.workspaceRoot);
    }
    /**
     * 检查权限
     */
        ...
        try {
            ...
            switch (operation) {
                ...
                case 'read':
                    ...
                    result = await this.fileManager.readFileWithLimits(params.filePath, params.offset || 1, params.limit || 1000);
                    break;
                case 'update':
                    this.reportProgress(onProgress, {
                        type: 'file_updating',
            ...
            if (result.success) {
                ...
                return this.createErrorResult(result.error || `File operation failed: ${operation}`, duration, {
                    operation,
                    filePath: params.filePath,
                    targetPath: params.targetPath,
                });
            ...
            return this.createErrorResult(`File operation failed: ${error.message}`, duration, {
                operation,
                filePath: params.filePath,
                targetPath: params.targetPath,
            });
...
//# sourceMappingURL=FileManagerAdapter.js.map