...
class PromptEngine {
    ...
    generatePrompt(task, context, options = {}) {
    ...
    generateJavaPrompt(task, context, options) {
...
`;
    ...
    generatePythonPrompt(task, context, options) {
...
`;
    ...
    generateWebPrompt(task, context, options) {
...
`;
    ...
    generateGeneralPrompt(task, context, options) {
        return `
# 角色设定
...
`;
    ...
    extractJavaConstraints(context) {
        const constraints = [];
    ...
    extractPythonConstraints(context) {
        const constraints = [];
