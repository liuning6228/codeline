...
describe('MCPHandler Production Integration', () => {
    ...
    describe('Configuration Management', () => {
        it('should initialize with default configuration', async () => {
            const handler = new MCPHandler_1.MCPHandler(mockContext);
        ...
        it('should accept custom configuration', async () => {
            ...
            const handler = new MCPHandler_1.MCPHandler(mockContext, config);
            // 测试配置是否正确设置
    ...
    describe('Error Handling and Resilience', () => {
        it('should handle malformed messages gracefully', async () => {
            ...
            const invalidMessages = [
                { type: '', data: {} }, // 空类型
                { type: 123, data: {} }, // 非字符串类型
                { type: 'test', data: 'not-an-object' }, // 无效数据
                { type: 'test', data: {}, timestamp: 'invalid' } // 无效时间戳
            ];
    ...
    describe('Monitoring and Metrics', () => {
        it('should track request metrics', async () => {
            const handler = new MCPHandler_1.MCPHandler(mockContext, { enableMonitoring: true, monitoringSampleRate: 1.0 });
            await handler.initialize(testWorkspaceRoot);
            // 发送多个消息
            const messages = [
    ...
    describe('Configuration Operations', () => {
        it('should support get/set config operations', async () => {
            ...
            // 获取特定配置项
            const getSpecificConfigMessage = {
                type: 'mcp_config',
...
//# sourceMappingURL=MCPHandlerProduction.test.js.map