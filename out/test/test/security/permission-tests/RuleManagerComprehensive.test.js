...
(0, mocha_1.describe)('RuleManager 综合测试套件', () => {
    ...
    (0, mocha_1.describe)('3. 规则学习和适应', () => {
        ...
        mocha_1.it.skip('应该更新现有规则而不是重复创建 - 需要修复findSimilarRule逻辑', () => {
            // 先添加一个规则
            const existingRule = {
    ...
    (0, mocha_1.describe)('6. 综合场景测试', () => {
        mocha_1.it.skip('应该模拟实际使用场景 - 需要修复pattern匹配和条件逻辑', () => {
            // 模拟实际工具的权限规则
...
//# sourceMappingURL=RuleManagerComprehensive.test.js.map