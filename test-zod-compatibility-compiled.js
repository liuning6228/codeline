...
try {
  ...
  try {
    ...
    console.log(`  compatibility.object()测试跳过: ${error.message}`);
  }
  ...
  console.error('❌ 编译后的Zod兼容性层测试失败:', error.message);
