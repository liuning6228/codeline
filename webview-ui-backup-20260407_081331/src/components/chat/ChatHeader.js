...
var ChatHeader = function (_a) {
    var onClearChat = _a.onClearChat;
    return (<div className="flex items-center justify-between border-b border-border px-4 py-3">
      ...
      <div className="flex items-center space-x-2">
        <button className="flex items-center space-x-2 rounded-lg border border-border bg-secondary px-3 py-1.5 text-sm hover:bg-secondary/80" onClick={onClearChat}>
