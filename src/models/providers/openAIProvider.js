...
var OpenAIProvider = /** @class */ (function (_super) {
    ...
    OpenAIProvider.prototype.getDefaultConfig = function () {
        return {
    ...
    OpenAIProvider.prototype.getConfigHint = function () {
        return '请设置OpenAI API密钥（可在 https://platform.openai.com/api-keys 获取）';
    };
    OpenAIProvider.prototype.generate = function (prompt, config) {
        return __awaiter(this, void 0, void 0, function () {
            var headers, data, url, result;
            var _a, _b;
    ...
    OpenAIProvider.prototype.validateConfig = function (config) {
