...
function convertModelInfoToProtoOpenRouter(info: any | undefined): OpenRouterModelInfo | undefined {
	if (!info) {
		return undefined
	}
...
function convertOcaModelInfoToProtoOcaModelInfo(info: any | undefined): ProtoOcaModelInfo | undefined {
	if (!info) {
		return undefined
	}
	...
	return {
		...
		apiFormat: info.apiFormat as any, // ApiFormat is string alias
...
export function convertApiConfigurationToProto(config: ApiConfiguration): ProtoApiConfiguration {
	return {
		...
		planModeOpenRouterModelInfo: convertModelInfoToProtoOpenRouter(config.planModeOpenRouterModelInfo as any),
		...
		planModeOpenAiModelInfo: convertOpenAiCompatibleModelInfoToProto(config.planModeOpenAiModelInfo as any),
		...
		planModeLiteLlmModelInfo: convertLiteLLMModelInfoToProto(config.planModeLiteLlmModelInfo as any),
		...
		planModeAihubmixModelInfo: convertOpenAiCompatibleModelInfoToProto(config.planModeAihubmixModelInfo as any),
		...
		actModeOpenAiModelInfo: convertOpenAiCompatibleModelInfoToProto(config.actModeOpenAiModelInfo as any),
		...
		actModeLiteLlmModelInfo: convertLiteLLMModelInfoToProto(config.actModeLiteLlmModelInfo as any),
